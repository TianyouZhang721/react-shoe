...
export default class Banner extends Component {
    ...
    render() {
        ...
        var controlNodes = <BannerControl item={this.props.items} turn={this.turn.bind(this)} count={count} nowLocal={this.state.nowLocal}/>
        return (
            ...
            >
                ...
                {this.props.dots ? controlNodes: null}
            </div>
        )
    }
}
